"""
Auth helpers: password hashing + JWT issue/verify.
Two roles only -> "admin" and "employee". Every protected route checks
the role on the token, not just the user's existence.
"""
